...
# =======================================Total prize===========================================
        self.ctotalprize=float((laptop1*laptop2)+(mouse1*mouse2)+(keyboard1*keyboard2)+(monitor1*monitor2)\
...
# =======================================Total tax===========================================
        self.ctotaltax = float(ctotalprize*0.05)
...
# =======================================Total===========================================
    ...
    def billarea(self):
        if self.c_name.get()=="" or self.phone1.get()=="":
            ...
            if self.totalprize1.get()!="Rs.0.0":
               self.text.insert(END, f"\n-------------------------------------------------------------------")
               self.text.insert(END,f"\n  Total Product Prize  :  {self.totalprize1.get()}")
            if self.totaltax1.get() != "Rs.0.0":
              self.text.insert(END,f"\n  Total Product Tax  :     {self.totaltax1.get()}")
            if self.total1.get() != "Rs.0.0":
              self.text.insert(END,f"\n-------------------------------------------------------------------")
